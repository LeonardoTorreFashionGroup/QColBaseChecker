...
DIR_CORRIGIDOS = r"H:\Informatica\LEONARDOCRUZ\Projetos\QColChecker\corrigidos"
os.makedirs(DIR_TEMP, exist_ok=True)
os.makedirs(DIR_CORRIGIDOS, exist_ok=True)
...
def gerar_corrigido_path(orig_path: str) -> str:
    """
    Gera um nome em DIR_CORRIGIDOS com sufixo '_corrigido_<timestamp>'.
    """
    base, ext = os.path.splitext(os.path.basename(orig_path))
    return os.path.join(DIR_CORRIGIDOS, f"{base}_corrigido_{timestamp()}{ext}")
